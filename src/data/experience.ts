...
export const timeline: TimelineEntry[] = [
  {
    ...
    bullets: [
      ...
      "Built Agency MBS analytics (CPR and S-curve analysis, WALA ramps over custom-built cohorts from loan-level data) to evaluate the relative performance and prepayment tendencies of a CUSIP against its broader cohort.",
